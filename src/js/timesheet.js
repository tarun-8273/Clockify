...
displayTimesheet = () =>{
    ...
    array.map((item,index) => {
        ...
        <div class="Timesheet__table__body">
            ...
            <div class="Timesheet__table__details">
                <div>
                    <p>${item.monday.time} Sec</p>
                </div>
                <div>
                    <p> ${item.tuesday.time} Sec</p>
                </div>
                <div>
                    <p> ${item.wednesday.time} Sec</p>
                </div>
                <div>
                    <p> ${item.thursday.time} Sec</p>
                </div>
                <div>
                    <p> ${item.friday.time} Sec</p>
                </div>
                <div>
                    <p> ${item.saturday.time} Sec</p>
                </div>
                <div>
                    <p>${item.sunday.time} Sec</p>
                </div>
                <div>
                    <p>${colSum} Sec</p>
                </div>
    ...
    document.getElementById("monTotal").innerHTML = rowMon + " Sec";
    document.getElementById("tueTotal").innerHTML = rowTue + " Sec";
    document.getElementById("wedTotal").innerHTML = rowWed + " Sec";
    document.getElementById("thuTotal").innerHTML = rowThu + " Sec";
    document.getElementById("friTotal").innerHTML = rowFri + " Sec";
    document.getElementById("satTotal").innerHTML = rowSat + " Sec";
    document.getElementById("sunTotal").innerHTML = rowSun + " Sec";
    document.getElementById("sumTotal").innerHTML = sumTotal + " Sec";
